...
impl<F: Extendable<2>, T: ::core::borrow::Borrow<QuadraticExtension<F>>> ::core::iter::Sum<T>
    for QuadraticExtension<F>
{
...
impl<F: Extendable<2>, T: ::core::borrow::Borrow<QuadraticExtension<F>>> ::core::iter::Product<T>
    for QuadraticExtension<F>
{
